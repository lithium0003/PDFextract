// https://github.com/nodec-project/nodec/blob/main/include/nodec/unicode.hpp
...
inline void throw_illegal_character_exception(const char *file, size_t line) {
    throw std::runtime_error("Illegal character found.");
}

inline void throw_buffer_range_exception(const char *file, size_t line) {
    throw std::runtime_error("Cannot add characters to buffer, output is too small.");
}
